def print_progress(epoch, total_number_epochs, loss):
    """
    ...
    if epoch == total_number_epochs:
        print(f'Step: {epoch + 1}/{total_number_epochs} - Loss: {loss: .4f}')
    else:
        print(f'Step: {epoch + 1}/{total_number_epochs} - Loss: {loss: .4f}', end="\r")
